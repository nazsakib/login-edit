...
<?php
    ...
    $query = mysqli_query($connection, "SELECT * FROM pages WHERE pageid = 'Homepage'");
...
<head>
    ...
    <script src="https://cdn.tiny.cloud/1/ewhcmn84ehzszyd0dtbod50wa0q5sy84uqf2ju3iok9f10f4/tinymce/6/tinymce.min.js" referrerpolicy="origin"></script>
